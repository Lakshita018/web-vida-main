      ...
      <div className="quiz-container">
        {submitted ? (
          ...
          <div className="buttons">
            <button className="previous" onClick={prevQuestion} disabled={currentQuestion === 0}>Previous</button>
            {currentQuestion < questions.length - 1 ? <button className="next" onClick={nextQuestion}>Next</button> : <button className="next" onClick={handleSubmit}>Submit</button>}
          </div>
        </>
        )}
      </div>
